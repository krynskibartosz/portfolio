      ...
      >
        <Row className="max-w-5xl mx-auto max-md:p-5" positionX="center">
          <Row
            ...
            className="py-2 duration-500 ease-in-out bg-white border border-gray-100 dark:bg-[#1d1d1fb8]  bg-opacity-20 backdrop-blur-sm rounded-2xl dark:border-gray-700 max-md:py-0 max-md:px-0 gap-x-2 max-md:border-none max-md:bg-none max-md:backdrop-blur-0 max-md:bg-opacity-0 "
            style={{
